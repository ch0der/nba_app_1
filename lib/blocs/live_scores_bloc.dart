...
class StandingsDetails {

  final standingsData = BehaviorSubject<LiveGameData01>();


  Stream<LiveGameData01> get dataScores => standingsData.stream;

  Function(LiveGameData01)get addData => standingsData.sink.add;
  ...
  Future fetchStandings() async {
    ...
    if (response.statusCode == 200) {
      ...
      standingsData.sink.add(LiveGameData01.fromJson(info['api']));
